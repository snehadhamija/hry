            ...
            <div class="container">
                <div class="page-header">
                    <div class="page-title">
                        <h3>Menu Category Service</h3>
                        <div class="crumbs">
                            <ul id="breadcrumbs" class="breadcrumb">
                                <li><a href="index.php"><i class="flaticon-home-fill"></i></a></li>
                                <li><a href="#">Tables</a></li>
                               
                              <li class="active"><a href="#">Menu Category Service</a> </li>
                            </ul>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="table-responsive mb-4">
                                    ...
                                    <table id="html5-extension" class="table table-striped table-bordered table-hover" style="width:100%">
										...
										<?php
											...
											echo  '<td>'.$value['menuCategory']['id'] .'</td>' ;
...
<a class="dropdown-item" href="addservice.php?id=<?php echo $value['id']; ?>">Add</a>
<a class="dropdown-item" href="serviceedit.php?id=<?php echo $value['id']; ?>">Edit</a>
<a class="dropdown-item" href="menu_cat_service.php?id=<?php echo $value['id']; ?>">Delete</a>
                                                        </div>
                                                      </div>
                                                </td>
											</tr>
