		...
		<div class="row">
			<div class="col-md-11">
				<div class="panel panel-default">
                    ...
                    <p style="font-size:14px;"><a href="index.php">Home</a>-><a href="menu_category.php">Menu Category</a>-><a href="editcategory.php">Edit Menu Category</a>
			</p>
                    </div>
...
<input type="text" name="menu" id="menu" class="form-control" maxlength="100"placeholder=" <?php echo $value['category'];?>">
								...
								<div class="col-md-9">
								<input type="text" name="sequenceId" id="sequenceId" class="form-control" maxlength="100"placeholder=" <?php echo $value['sequenceId'];?>">
								</div>
								</div>
								<?php
											}
