		...
		<div class="row">
			<div class="col-md-11">
				<div class="panel panel-default">
                    ...
                    <p style="font-size:14px;"><a href="welcome.php">Home</a>-><a href="menu.php">Menu</a>-><a href="menu_detail.php">Edit Menu Category</a>
						...
						<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
							<fieldset>
								...
								<div class="form-group">
									<label class="col-md-3 control-label" for="name" style="color:Blue;font-size:20px">Menu</label>
									<div class="col-md-9">
									<select name="menu" id="menu" class="form-control" onChange="addmenus();" title="Select Menu">
										<?php
                                ...
                                <div class="form-group" style="display:none;" id="addmenus">
								 ...
								 <div class="form-group">
									...
									<div class="col-md-9">
									<input type="text" name="sequenceid" id="sequenceid" class="form-control" maxlength="100" placeholder="sequence id" value="<?php
											
											if($value['menu]['id']==1)
											{
											echo  ''.$value['sequenceId'] .'' ;
		...
		$.ajax({
			...
			/*success: function(response) {
				if(response.trim() == 'SUCCESS'){
					$('#statusmsg').html('').html('<p style="color:green"> Your Data Submit
				} else {
