...
var mid = '';
	...
	<div class="form-group">
									<label class="col-md-3 control-label" for="name">Menu</label>
									<div class="col-md-9">
									<select name="menucategory" id="menucategory" class="form-control" onChange="addmenus();">
										<?php
											$id = $value['id'];
									...
									<div class="col-md-9">
									<select name="menucatservice" id="menucatservice" class="form-control" onChange="addmenus();">
										<?php
