		...
		<div class="row">
			<div class="col-md-11">
				<div class="panel panel-default">
                    ...
                    <p style="font-size:14px;"><a href="index.php">Home</a>-><a href="menu_cat_service.php">Menu Category Service</a>-><a href="addservice.php">Add Menu Category Service</a>
			</p>
                    </div>
...
<input type="text" name="menu" id="menu" class="form-control" maxlength="100"placeholder=" ">
								...
								<div class="col-md-9">
								<input type="text" name="mcid" id="mcid" class="form-control" maxlength="100"placeholder=" ">
								</div>
								</div>
								<div class="form-group">
								<label class="col-md-3 control-label" for="name">Sequence Id</label>
								<div class="col-md-9">
								<input type="text" name="sequenceId" id="sequence" class="form-control" maxlength="100"placeholder=" ">
								</div>
								</div>
								<?php
											}
