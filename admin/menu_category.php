...
<a class="dropdown-item" href="addcategory.php?id=<?php echo $value['id']; ?>">Add</a>
<a class="dropdown-item" href="editcategory.php?id=<?php echo $value['id']; ?>">Edit</a>
<a class="dropdown-item" href="menu_category.php?id=<?php echo $value['id']; ?>">Delete</a>
 </div>
</div>
 </td>
											</tr>
