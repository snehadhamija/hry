		...
		<div class="row">
			<div class="col-md-11">
				<div class="panel panel-default">
                    ...
                    <p style="font-size:14px;"><a href="welcome.php">Home</a>-><a href="table.php">Menu</a>-><a href="editmenu.php">Edit Menu</a>
...
$.ajax({
	...
	/*success: function(response)
	{
		...
		{
		$('#statusmsg').html('').html('<p style="color:green">your enquiry send
		}else{
