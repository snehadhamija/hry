...
<input type="text" name="menu" id="menu" class="form-control" maxlength="100"placeholder=" <?php echo $value['menu'];?>">
								</div>
								</div>
								...
								<div class="col-md-9">
								<input type="text" name="menu" id="menu" class="form-control" maxlength="100"placeholder=" <?php echo $value['sequenceId'];?>">
								</div>
								</div>
								<?php
											}
